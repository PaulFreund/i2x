    ...
    // Methods
        ...
        init = function(_events, _config) {
            ...
            ircServer.addListener('message', function(from, to, message) {
                ...
                // Remove IRC Coloring :X
                message = message.replace(/[\x00-\x1F\x80-\xFF]/g, "");
            ...
            ircServer.addListener('quit', function(nick, reason, channels) {
                events.emit(name,'quit', channels, nick);
            });
